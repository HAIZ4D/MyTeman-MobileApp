...
/// My Applications Screen - displays user's submitted applications
class OnboardingVoiceScreen extends ConsumerStatefulWidget {
  final User user;

  const OnboardingVoiceScreen({super.key, required this.user});

  @override
  ConsumerState<OnboardingVoiceScreen> createState() => _OnboardingVoiceScreenState();
}

class _OnboardingVoiceScreenState extends ConsumerState<OnboardingVoiceScreen> {
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      Expanded(
                        child: Text(
                          service?.title ?? application.serviceId,
